...
/*----------------------------------------------------------------------------------------------------------------------
-- FUNCTION: CommandEntity::SendSkill
--
-- DATE: April 5, 2015
--
-- REVISIONS:
...
--
-- INTERFACE: void CommandEntity::SendSkill(float curX, float curY, int radius, int value, SKILLTYPE st)
--
-- PARAMETERS:
--      curX    -> The x coordinate of the skill event
--      curY    -> The y coordinate of the skill event
--      radius  -> The radius of the skill event
--      value   -> The value of the skill event
--      st      -> The skill type of the skill event
--
-- RETURNS: ENTITY_TYPES
--
-- NOTES:
--  Sends the skill message to the server.
----------------------------------------------------------------------------------------------------------------------*/
